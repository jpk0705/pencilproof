    ...
    <main className="sales-page shell">
      ...
      <section className="sales-problem-solution" aria-labelledby="sales-problem-title">
        ...
        <div className="sales-story-grid">
          <div className="sales-story-column sales-story-problems"><p className="sales-story-label">WITHOUT A CLEAR REVIEW</p><article><strong>Payment details are scattered</strong><span>Price, fees, products, trade equity, APR, and term may be spread across a dense worksheet.</span></article><article><strong>Conversations slow down</strong><span>You may need to pause and retrace the math before you can explain what changed or what is optional.</span></article><article><strong>Revised quotes restart the work</strong><span>When figures change, it can be hard to compare the new worksheet with the earlier version.</span></article></div>
