  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-copy shell">
        ...
        <h2>Verify the numbers</h2><p>PDF extraction may miss, misread, or misclassify figures because dealer documents use different formats and labels. Vehicle taxes, registration fees, trade credits, lender rules, product pricing, and disclosures also vary by state and transaction. Review every imported field and verify the final contract with the dealership, lender, and appropriate licensed professionals before signing.</p>
