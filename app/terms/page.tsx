  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-copy shell">
        ...
        <h2>Purchase and delivery</h2><p>A $39 purchase provides access to the automated browser-based Full Quote Audit for a financed vehicle purchase. It is a one-time purchase, not a subscription. Access is delivered through the confirmation shown after successful checkout. You are responsible for saving or printing any audit you want to keep.</p>
