    ...
    <main>
      ...
      <section className="page-hero shell">
        <div className="page-hero-copy">
          ...
          <div className="page-actions"><Link className="button button-primary" href="/analyze">Review your quote free <span aria-hidden="true">→</span></Link><Link className="text-link" href="/pricing">Pricing <span aria-hidden="true">→</span></Link></div>
        </div>
      </section>
