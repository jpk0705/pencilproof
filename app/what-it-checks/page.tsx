    ...
    <main>
      ...
      <section className="page-hero shell">
        <div className="page-hero-copy">
          ...
          <div className="page-actions"><Link className="button button-primary" href="/#free-scan">Scan my quote free <span aria-hidden="true">→</span></Link><Link className="text-link" href="/questions">Read common questions <span aria-hidden="true">→</span></Link></div>
        </div>
      </section>
