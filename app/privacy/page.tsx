  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-copy shell">
        ...
        <h2>The short version</h2><p>The deal analyzer and PDF importer run in your web browser. The financial figures you enter or import are used on your device to calculate the displayed results and are not intentionally sent to, or stored by, PencilProof.</p>
        <h2>Information processed</h2><p>The analyzer processes the vehicle description, prices, fees, products, trade information, loan rates, term, and payment you choose to enter. If you choose a PDF, compatible text is read locally in your browser to suggest values for those fields. The PDF itself and extracted text are not intentionally uploaded to PencilProof. Avoid files containing Social Security numbers, bank details, driver&apos;s license numbers, or other unnecessary identifiers.</p>
